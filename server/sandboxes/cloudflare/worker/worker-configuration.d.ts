/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ebe941e7896815b30cbbd11380516274)
// Runtime types generated with workerd@1.20260131.0 2025-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PiSandbox";
	}
	interface Env {
		STATE_BUCKET: R2Bucket;
		RELAY_SECRET: string;
		PI_SANDBOX: DurableObjectNamespace<import("./src/index").PiSandbox>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELAY_SECRET">> {}
}
