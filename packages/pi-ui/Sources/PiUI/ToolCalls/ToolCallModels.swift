...
// MARK: - Client.ToolCallStatus Extension

extension Client.ToolCallStatus {
...
public enum ParsedToolArgs: Sendable {
    ...
    case list(path: String, limit: Int?)
...
public struct OutputPreview: Sendable {
...
public struct ToolOutputFormatter {
    ...
    public static func preview(_ output: String?, maxLines: Int = 10) -> OutputPreview {
        guard let output, !output.isEmpty else {
            return OutputPreview(lines: [], hasMore: false, moreCount: 0)
        }
