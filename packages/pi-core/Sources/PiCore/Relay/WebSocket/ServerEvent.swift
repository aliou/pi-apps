...
extension ServerEvent: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "sandbox_status":
            let status = try container.decode(SandboxStatus.self, forKey: DynamicCodingKeys.string("status"))
        ...
        case "agentEnd":
            let messages = try container.decode([AnyCodable].self, forKey: DynamicCodingKeys.string("messages"))
        ...
        case "turnEnd":
            let message = try container.decode(AnyCodable.self, forKey: DynamicCodingKeys.string("message"))
            let toolResults = try container.decode([AnyCodable].self, forKey: DynamicCodingKeys.string("toolResults"))
        ...
        case "messageUpdate":
            ...
            let assistantMessageEvent = try container.decode(
                AnyCodable.self, forKey: DynamicCodingKeys.string("assistantMessageEvent")
            )
        ...
        case "toolExecutionStart":
            ...
            let args = try container.decode(AnyCodable.self, forKey: DynamicCodingKeys.string("args"))
        ...
        case "toolExecutionUpdate":
            ...
            let partialResult = try container.decode(
                AnyCodable.self, forKey: DynamicCodingKeys.string("partialResult")
            )
        ...
        case "toolExecutionEnd":
            let toolCallId = try container.decode(String.self, forKey: DynamicCodingKeys.string("toolCallId"))
            let toolName = try container.decode(String.self, forKey: DynamicCodingKeys.string("toolName"))
            let result = try container.decode(AnyCodable.self, forKey: DynamicCodingKeys.string("result"))
        ...
        case "extensionUIRequest":
            ...
            let payload = try container.decode(AnyCodable.self, forKey: DynamicCodingKeys.string("payload"))
        ...
        case "response":
            ...
            let success = try container.decode(Bool.self, forKey: DynamicCodingKeys.string("success"))
            let data = try container.decodeIfPresent(AnyCodable.self, forKey: DynamicCodingKeys.string("data"))
